...
import { Zap, Sparkles, Mail, Lock, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-slate-50 dark:bg-slate-950">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Sign in to your FocusFlow AI workspace</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-8 shadow-sm">
          ...
          <div className="mb-6 p-3.5 rounded-xl bg-brand-50 border border-brand-200/60 dark:bg-brand-950/40 dark:border-brand-900/60 flex items-center justify-between gap-3">
            <div>
              ...
              <p className="text-[11px] text-brand-700 dark:text-brand-400 mt-0.5">Use pre-seeded demo credentials</p>
            </div>
            <button
              type="button"
              onClick={handleFillDemo}
              className="px-2.5 py-1 text-xs font-bold text-white bg-brand-600 hover:bg-brand-700 rounded-lg shadow-sm"
            >
              Fill Demo
            </button>
          </div>
